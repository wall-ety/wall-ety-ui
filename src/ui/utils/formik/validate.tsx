export function required() {
  return (fieldName: string, value: any) => !value ? `${fieldName} is required` : undefined
}

export function number() {
  return (fieldName: string, value: any) => isNaN(value) ? `${fieldName} must be a number` : undefined;
}
