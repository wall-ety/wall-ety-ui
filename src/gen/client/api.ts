...
export const BalancesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBalancesByAccountId: async (accountId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
...
export const BalancesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBalancesByAccountId(accountId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Balance>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBalancesByAccountId(accountId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const BalancesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getBalancesByAccountId(accountId: string, options?: any): AxiosPromise<Array<Balance>> {
            return localVarFp.getBalancesByAccountId(accountId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get Current Balance for an Account
...
export class BalancesApi extends BaseAPI {
     ...
     */
    public getBalancesByAccountId(accountId: string, options?: RawAxiosRequestConfig) {
        return BalancesApiFp(this.configuration).getBalancesByAccountId(accountId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const BanksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllBanks: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/banks`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const BanksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllBanks(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Bank>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllBanks(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const BanksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getAllBanks(options?: any): AxiosPromise<Array<Bank>> {
            return localVarFp.getAllBanks(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get one Bank by id
...
export class BanksApi extends BaseAPI {
    ...
    public getAllBanks(options?: RawAxiosRequestConfig) {
        return BanksApiFp(this.configuration).getAllBanks(options).then((request) => request(this.axios, this.basePath));
    }
...
export const ClientsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllClients(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Client>>> {
...
export const TransactionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactionsByAccountId: async (accountId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
...
export const TransactionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTransactionsByAccountId(accountId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Transaction>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTransactionsByAccountId(accountId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const TransactionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTransactionsByAccountId(accountId: string, options?: any): AxiosPromise<Array<Transaction>> {
            return localVarFp.getTransactionsByAccountId(accountId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TransactionsApi extends BaseAPI {
     ...
     * @memberof TransactionsApi
     */
    public getTransactionsByAccountId(accountId: string, options?: RawAxiosRequestConfig) {
        return TransactionsApiFp(this.configuration).getTransactionsByAccountId(accountId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const TransfersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTransfersByAccountId: async (accountId: string, direction?: TransferDirection, status?: TransferStatus, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
...
export const TransfersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTransfersByAccountId(accountId: string, direction?: TransferDirection, status?: TransferStatus, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Transfer>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTransfersByAccountId(accountId, direction, status, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const TransfersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTransfersByAccountId(accountId: string, direction?: TransferDirection, status?: TransferStatus, options?: any): AxiosPromise<Array<Transfer>> {
            return localVarFp.getTransfersByAccountId(accountId, direction, status, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TransfersApi extends BaseAPI {
     ...
     * @memberof TransfersApi
     */
    public getTransfersByAccountId(accountId: string, direction?: TransferDirection, status?: TransferStatus, options?: RawAxiosRequestConfig) {
        return TransfersApiFp(this.configuration).getTransfersByAccountId(accountId, direction, status, options).then((request) => request(this.axios, this.basePath));
    }
}
