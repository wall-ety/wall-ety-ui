...
export const AccountsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getAccountBankStatements: async (
      ...
      const localVarPath = `/accounts/{accountId}/bank-statements`.replace(
        `{${"accountId"}}`,
    ...
    getAccountCategoriesStatements: async (
      ...
      const localVarPath =
        `/accounts/{accountId}/categories/statements`.replace(
          `{${"accountId"}}`,
          encodeURIComponent(String(accountId))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getAccountTransactionsStatements: async (
      ...
      const localVarPath =
        `/accounts/{accountId}/transactions/statements`.replace(
          `{${"accountId"}}`,
          encodeURIComponent(String(accountId))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AccountsApiFactory = function (
  ...
  return {
    ...
    getAccountBankStatements(
      ...
      return localVarFp
        .getAccountBankStatements(accountId, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getAccountCategoriesStatements(
      ...
      return localVarFp
        .getAccountCategoriesStatements(accountId, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getAccountTransactionsStatements(
      ...
      return localVarFp
        .getAccountTransactionsStatements(accountId, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const BalancesApiFactory = function (
  ...
  return {
    ...
    getBalancesByAccountId(
      ...
      return localVarFp
        .getBalancesByAccountId(accountId, order, orderBy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export const TransactionsApiFactory = function (
  ...
  return {
    ...
    getTransactionsByAccountId(
      ...
      return localVarFp
        .getTransactionsByAccountId(accountId, order, orderBy, options)
        .then((request) => request(axios, basePath));
    },
  };
};
