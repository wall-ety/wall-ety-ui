...
export const AccountsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @param {string} idAccount Id of the account
     * @param {string} [from] date from what you want to retrieve data
     * @param {string} [to] end date from what you want to retrieve data
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getAccountBankStatements: async (
      idAccount: string,
      from?: string,
      to?: string,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getAccountBankStatements", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}/bank-statements`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getAccountById: async (
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getAccountById", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getAccountCategoriesStatements: async (
      idAccount: string,
      from?: string,
      to?: string,
      options: RawAxiosRequestConfig = {}
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists(
        "getAccountCategoriesStatements",
        "idAccount",
        idAccount
      );
      const localVarPath =
        `/accounts/{idAccount}/categories/statements`.replace(
          `{${"idAccount"}}`,
          encodeURIComponent(String(idAccount))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getAccountTransactionsStatements: async (
      idAccount: string,
      from?: string,
      to?: string,
      options: RawAxiosRequestConfig = {}
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists(
        "getAccountTransactionsStatements",
        "idAccount",
        idAccount
      );
      const localVarPath =
        `/accounts/{idAccount}/transactions/statements`.replace(
          `{${"idAccount"}}`,
          encodeURIComponent(String(idAccount))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AccountsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getAccountBankStatements(
      idAccount: string,
      from?: string,
      to?: string,
      options?: RawAxiosRequestConfig
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAccountBankStatements(
          idAccount,
          from,
          to,
          options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AccountsApi.getAccountBankStatements"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getAccountCategoriesStatements(
      idAccount: string,
      from?: string,
      to?: string,
      options?: RawAxiosRequestConfig
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<CategoryStatement>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAccountCategoriesStatements(
          idAccount,
          from,
          to,
          options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AccountsApi.getAccountCategoriesStatements"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getAccountTransactionsStatements(
      idAccount: string,
      from?: string,
      to?: string,
      options?: RawAxiosRequestConfig
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<TransactionStatement>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAccountTransactionsStatements(
          idAccount,
          from,
          to,
          options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AccountsApi.getAccountTransactionsStatements"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const AccountsApiFactory = function (
  ...
  return {
    ...
    getAccountBankStatements(
      ...
      return localVarFp
        .getAccountBankStatements(idAccount, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getAccountById(idAccount: string, options?: any): AxiosPromise<Account> {
      return localVarFp
        .getAccountById(idAccount, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getAccountCategoriesStatements(
      ...
      return localVarFp
        .getAccountCategoriesStatements(idAccount, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getAccountTransactionsStatements(
      ...
      return localVarFp
        .getAccountTransactionsStatements(idAccount, from, to, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class AccountsApi extends BaseAPI {
   ...
   * @memberof AccountsApi
   */
  public getAccountBankStatements(
    idAccount: string,
    from?: string,
    to?: string,
    options?: RawAxiosRequestConfig
   ...
   * @memberof AccountsApi
   */
  public getAccountById(idAccount: string, options?: RawAxiosRequestConfig) {
    return AccountsApiFp(this.configuration)
      .getAccountById(idAccount, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof AccountsApi
   */
  public getAccountCategoriesStatements(
    idAccount: string,
    from?: string,
    to?: string,
    options?: RawAxiosRequestConfig
   ...
   * @memberof AccountsApi
   */
  public getAccountTransactionsStatements(
    idAccount: string,
    from?: string,
    to?: string,
    options?: RawAxiosRequestConfig
...
export const BalancesApiAxiosParamCreator = function (
  ...
  return {
    ...
    getBalancesByAccountId: async (
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getBalancesByAccountId", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}/balances`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getCurrentBalance: async (
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getCurrentBalance", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}/balances/current`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const BalancesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCurrentBalance(idAccount, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
...
export const BalancesApiFactory = function (
  ...
  return {
    ...
    getBalancesByAccountId(
      ...
      return localVarFp
        .getBalancesByAccountId(idAccount, order, orderBy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getCurrentBalance(
      ...
      return localVarFp
        .getCurrentBalance(idAccount, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class BalancesApi extends BaseAPI {
   ...
   * @memberof BalancesApi
   */
  public getCurrentBalance(idAccount: string, options?: RawAxiosRequestConfig) {
    return BalancesApiFp(this.configuration)
      .getCurrentBalance(idAccount, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const TransactionsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getTransactionsByAccountId: async (
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getTransactionsByAccountId", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}/transactions`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TransactionsApiFactory = function (
  ...
  return {
    ...
    getTransactionsByAccountId(
      ...
      return localVarFp
        .getTransactionsByAccountId(idAccount, order, orderBy, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const TransfersApiAxiosParamCreator = function (
  ...
  return {
    ...
    cancelById: async (
      ...
      const localVarPath = `/transfers/{transferId}/cancel`.replace(
        `{${"transferId"}}`,
    ...
    /**
     *
     * @summary create list of Transfers
     * @param {boolean} [externBank] say if your transfers are from another bank or not
    ...
    createTransfers: async (
      ...
      if (externBank !== undefined) {
        localVarQueryParameter["externBank"] = externBank;
      }
    ...
    getTransfersByAccountId: async (
      ...
      // verify required parameter 'idAccount' is not null or undefined
      assertParamExists("getTransfersByAccountId", "idAccount", idAccount);
      const localVarPath = `/accounts/{idAccount}/transfers`.replace(
        `{${"idAccount"}}`,
        encodeURIComponent(String(idAccount))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TransfersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async cancelById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.cancelById(
        transferId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransfersApi.cancelById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createTransfers(
        externBank,
        createTransfer,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransfersApi.createTransfers"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Transfer>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransfersApi.getById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const TransfersApiFactory = function (
  ...
  return {
    ...
    createTransfers(
      ...
      return localVarFp
        .createTransfers(externBank, createTransfer, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
